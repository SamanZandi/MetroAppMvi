...
import com.zandroid.metromvp.databinding.ItemLinesBinding
import com.zandroid.metromvp.databinding.StationRowBinding
...
import com.zandroid.metromvp.mvp.data.model.ResponseStation.ResponseStationItem
    ...
    inner class ViewHolder:RecyclerView.ViewHolder(binding.root){
        ...
        fun bind(item: ResponseStationItem){
            binding.apply {
                ...
                when(item.lineId){
                    1.toString() ->cardViewStation.setCardBackgroundColor(ContextCompat.getColor(context,R.color.bg_tajrish))
                    2.toString() ->cardViewStation.setCardBackgroundColor(ContextCompat.getColor(context,R.color.purple_700))
